...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="3.44.1-Solothurn">
  ...
  <aliases>
    ...
    <alias field="trench_depth" index="1" name="trench depth"/>
    <alias field="elevation" index="2" name="terrain elevation"/>
    <alias field="sink_coords" index="3" name="gps coordinates"/>
    <alias field="peak_flow" index="4" name="peak flow"/>
    <alias field="average_daily_flow" index="5" name="average daily flow"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="NO3N_obj" type="field" width="250"/>
      <column hidden="0" name="TN_obj" type="field" width="203"/>
      <column hidden="0" name="TP_obj" type="field" width="212"/>
      <column hidden="0" name="ecoli_obj" type="field" width="230"/>
