...
class EconomicalAlgorithm(QgsProcessingAlgorithm, Translatable):
    """
    ...
    def shortHelpString(self):
        ...
        """
        return self.tr("Economical module")
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if feedback is not None:
            feedback.pushInfo(self.tr(f"CRS is  {source.sourceCrs().authid()}"))
